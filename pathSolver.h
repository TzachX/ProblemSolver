//
// Created by zohar on 09/02/2020.
//

#ifndef FLIGHTSIM2ND_PATHSOLVER_H
#define FLIGHTSIM2ND_PATHSOLVER_H
...
{
    class PathSolver : public Solver<vector<vector<double>>,string>
    {
    public:
        ~PathSolver(){}
...
#endif //FLIGHTSIM2ND_PATHSOLVER_H
